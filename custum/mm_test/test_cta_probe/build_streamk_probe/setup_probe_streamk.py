"""
Probe-only streamk build for test_cta_probe.

Compiles bf16_gemm_sm80_streamk-style CUTLASS Stream-K with
  -DCUTLASS_CTA_PROBE_ENABLED
so that MmaMultistage::operator() records (smid, globaltimer_start,
